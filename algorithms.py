...
def train_PLOT(dataset, baseline_model, num_batches, batch_size, 
    ...
    for i in range(num_batches):
        ...
        with torch.no_grad():
            ...
            if pessimistic:
              pseudo_labels = torch.zeros(pseudo_label_filtered_batch_X.shape[0]).type(batch_y.dtype)
        ...
        instantaneous_regrets.append(instantaneous_regret.detach())
        instantaneous_accuracies.append(accuracy.detach())
