...
def run_and_plot(
    ...
    base_data_directory = "{}/experiment_results/T{}/{}/{}/data".format(
        path, max_num_steps, network_type, dataset
    )
    ...
    print(
        "Starting Experiment {} T{} {} {} {} epsilongreedy {} epsilon {} adjmahalanobis {} mahreg {} alpha {}".format(
            dataset,
            max_num_steps,
            training_mode,
            decision_type,
    ...
    plt.plot(
        timesteps,
        [mean_accuracy_validation_baseline_summary] * len(timesteps),
    ...
    plt.fill_between(
        ...
        [
            ...
            - 0.5 * std_accuracy_validation_baseline_summary
        ]
        * len(timesteps),
        [
            mean_accuracy_validation_baseline_summary
    ...
    plt.fill_between(
        timesteps,
        mean_loss_validation_averages - 0.5 * std_loss_validation_averages,
        mean_loss_validation_averages + 0.5 * std_loss_validation_averages,
        color="blue",
        alpha=0.1,
    )
    ...
    plt.fill_between(
        timesteps,
        mean_loss_validation_biased_averages
        - 0.5 * std_loss_validation_biased_averages,
        mean_loss_validation_biased_averages
        + 0.5 * std_loss_validation_biased_averages,
        color="red",
        alpha=0.1,
